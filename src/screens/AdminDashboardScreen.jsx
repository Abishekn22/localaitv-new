...
import NotebookLMUploader from './admin/NotebookLMUploader.jsx';
...
function AdminDashboardScreen({ onBack }) {
  ...
  const MODULES = [
    ...
    // NotebookLM upload — admin, master_admin, super_admin all have access
    // (need:null). Form calls Gyan's newspipeline API directly.
  ...
  function ModuleBody() {
    ...
    if (view === 'notebooklm') return <NotebookLMUploader/>;
