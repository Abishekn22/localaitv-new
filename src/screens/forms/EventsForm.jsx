  ...
  async function handleSubmit() {
    ...
    try {
      const photoUrls = mediaFiles.length
        ? await uploadPhotos(mediaFiles, reqId, 'event')
        : [];
      const res = await fetch(`${API}/event-listings`, {
        method: 'POST', headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          request_id: reqId, location_id: getUserLocationId(), event_name: eventName, event_type: eventType,
